    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    tableTypes = _a.sent();
                    interfaces += typescript_1.generateTableInterface(table, tableTypes, false, options);
                    interfaces += typescript_1.generateTableInterface(table, tableTypes, true, options);
